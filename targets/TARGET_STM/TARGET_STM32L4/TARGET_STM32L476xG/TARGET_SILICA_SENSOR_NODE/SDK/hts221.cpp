/* Copyright (c) 2017 AvNet Silica. All Rights Reserved.
 *
 * The information contained herein is property of Avnet Silica.
 *
...
float HTS221::ReadTemp( void )
{
  float humi, temp;
  ReadTempHumi( &temp, &humi );
  return temp;
}
